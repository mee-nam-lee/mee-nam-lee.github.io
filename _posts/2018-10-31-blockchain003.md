---
layout: post
title:  Node.js Fabric SDK를 사용하여 오라클 블록체인 클라우드에 배포된 Fabcar 체인코드 호출
categories: Blockchain
tags: [Blockchain, 오라클 블럭체인, Hyperledger Fabric, Node.js]
---

지난 기고에서 **Oracle Autonomous Blockchain Cloud Service**에 Hyperledger의 샘플체인 코드인 fabcar의 GO 버전과 Node.js 버전을 배포하고 REST API를 통해 배포된 체인코드를 호출하여 테스트 하는 과정에 대해 설명하였습니다. 
